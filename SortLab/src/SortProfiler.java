...
public class SortProfiler {
  ...
  private static final String[] ALL_SORT_NAMES =
      {"insertion", "selection", "merge", "quick", "timsort", "merge1", "merge2"};
  ...
  public static void main(String[] args) throws IOException {
    ...
    OptionSpec<String> sortSpec = parser.accepts("w",
        "Comma separated list of sorts. Options include insertion, selection, merge, merge1, merge2, quick, and timsort. Default is to execute all sorts.")
